...
class UserApiController extends Controller
{
                ...
                if ($user->status == 1) {
                    if ($user->roles->contains('title', 'user')) {
                        ...
                        if ($user['is_verified'] == 1) {
                            ...
                            $this->sendNotification($user, 'register');
    ...
    public function apiSendOtp(Request $request)
    {
        ...
        if ($user) {
            $this->sendNotification($user, $request->where);
    ...
    public function apiBookOrder(Request $request)
    {
        ...
        //     {
        //         $user->withdraw($bookData['amount'],['order_id' => 10]);
        //     }
        //     else
        //     {
    ...
    public function sendNotification($user, $where)
    {
        $admin_verify_user = GeneralSetting::find(1)->verification;
