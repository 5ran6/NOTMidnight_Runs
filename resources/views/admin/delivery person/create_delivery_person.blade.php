                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-md-6 mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <input type="number" min=1 name="phone_code" required class="form-control">
                                    </div>
                                    <div class="col-md-9">
                                        <input type="number" min=1 name="contact" value="{{ old('contact') }}" required class="form-control  @error('contact') is_invalide @enderror">
                                        @error('contact')
                                        <span class="custom_error" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
