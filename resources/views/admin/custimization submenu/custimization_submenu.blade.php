                                                        ...
                                                        <tbody id="{{'custom'.$custimization_type->id}}">
                                                            ...
                                                            @if ($items)
                                                                @foreach ($items as $item)
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" name="{{str_replace(' ', '_', strtolower('name'.$custimization_type->name.'[]'))}}"
                                                                ...
                                                                <tr id="{{'custom'.$custimization_type->id}}">
                                                                    ...
                                                                    <td>
                                                                        <button type="button" class="btn btn-primary"
                                                                            onclick="update_custimization({{$custimization_type->id}},'{{$custimization_type->name}}')">+</button>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        </tbody>
